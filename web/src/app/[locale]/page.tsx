...
[dir="rtl"] #rsel .rs-brand{left:auto;right:46px}
#rsel .rs-signin{position:absolute;top:46px;right:52px;z-index:30;display:flex;align-items:center;gap:14px;font-size:13px;color:var(--dim)}
[dir="rtl"] #rsel .rs-signin{right:auto;left:52px}
...
[dir="rtl"] #rsel .rs-badge{right:auto;left:18px}
