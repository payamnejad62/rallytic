  ...
  return (
    <>
      <Topbar
        ...
        breadcrumb={[{ label: "Academy" }, { label: "Compare" }]}
        actions={
          <>
            <GhostBtn icon="arrows-left-right" onClick={swap}>Swap</GhostBtn>
            <GhostBtn icon="plus">Add 3rd</GhostBtn>
            <PrimaryBtn icon="file-export">Export comparison</PrimaryBtn>
          </>
        }
      />
      <Styles />
