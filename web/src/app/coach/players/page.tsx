...
export default function PlayersRosterPage() {
  ...
  return (
    <>
      <Topbar
        title="Players"
        breadcrumb={[{ label: "Workspace", dim: true }, { label: "Roster" }]}
        actions={
          <>
            <GhostBtn icon="adjustments-horizontal">Filters</GhostBtn>
            <GhostBtn icon="file-spreadsheet">Export CSV</GhostBtn>
            <Link href="/coach" style={{ textDecoration: "none" }}>
              <PrimaryBtn icon="user-plus">New player</PrimaryBtn>
            </Link>
          </>
        }
      />
      ...
      <div className="r-page">
        <div className="rst-kpis">
          <div className="rst-kpi">
            ...
            <div>
              <div className="rst-kpi-k">Total players</div>
          ...
          <div className="rst-kpi">
            ...
            <div>
              <div className="rst-kpi-k">Active</div>
              <div className="rst-kpi-v">
                {active}
                <span className="rst-kpi-sub" style={{ color: "#A8D847" }}>
                  {Math.round((active / ROSTER.length) * 100)}%
                </span>
              </div>
            </div>
          </div>
          <div className="rst-kpi">
            ...
            <div>
              <div className="rst-kpi-k">Needs attention</div>
              <div className="rst-kpi-v">
                {flagged}
          ...
          <div className="rst-kpi">
            ...
            <div>
              <div className="rst-kpi-k">Avg ITN</div>
              <div className="rst-kpi-v">
                {avgItn}
                <span className="rst-kpi-sub" style={{ color: "#A8D847" }}>
                  +0.4 YoY
