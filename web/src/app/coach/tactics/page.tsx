...
export default function TacticsBoardPage() {
  ...
  return (
    <>
      <Topbar
        title="Tennis Tactics Board"
        breadcrumb={[{ label: "Workspace" }, { label: "Arman Rahimi" }, { label: "Tactics board" }]}
        actions={
          <>
            <GhostBtn icon="trash">Clear</GhostBtn>
            <GhostBtn icon="photo">Save image</GhostBtn>
            <GhostBtn icon="video">Save video</GhostBtn>
            <PrimaryBtn icon="device-floppy">Save scheme</PrimaryBtn>
          </>
        }
      />
      <Styles />
